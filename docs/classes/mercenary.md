...
![用心棒（Mercenary）キャラクター画像（準備中）](../images/placeholder_mercenary.svg)
</div>
...
!!! info "参考例：クールダウン回転＆火縄銃ビルド"
    プレイヤーの検証例として、「神威の苦無（Spirit Kunai）」に投げ物ダメージを盛ることで対複数殲滅力を跳ね上げるビルドや、火縄銃と併用する構成があります。
    百鬼九死のソロクリア報告などの実績もあるため、構築パターンのひとつとして参考になります。[（YouTube構築例）](../sources/youtube.md)
